...
module.exports = {
    ...
    QUESTIONS_EN_US: [
        {
            'Who is the current president of Dartmouth?': [
                'Phil Hanlon', 
                'Barack Obama', 
                'Jim Kim',
                'Donald Trump',
        ...
        {
            'What is the largest house at Dartmouth?': [
                'West House', 
                'Allen House',
                'South House',
                'North Park House',
        ...
        {
            'What is the most popular major at Dartmouth?': [
                'Economics',
                'Government',
                'History',
                'Computer Science',
        ...
        {
            'How many sports teams does Dartmouth have?': [
                '34',
                '25',
                '20',
                '40',
